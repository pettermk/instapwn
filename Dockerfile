...
FROM python-builder as python-builder-dapr
COPY requirements-dapr.txt .
RUN . /app/venv/bin/activate && pip install -r requirements-dapr.txt
...
FROM base as python-runner-dapr
USER root
